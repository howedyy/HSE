...
// ─── Shared Style Tokens ────────────────────────────────────────────────────
const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-700 text-sm bg-white dark:bg-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all";
const selectClass = inputClass;
const labelClass = "block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5";
const sectionHead = "text-xs uppercase tracking-wider text-indigo-600 font-semibold mb-3 pt-5 border-t border-gray-100 dark:border-slate-800 mt-5";
    ...
    if (!hasPermission('ptw.php', 'submit')) {
        return (
            <div className="max-w-lg mx-auto text-center py-20">
                ...
                <p className="text-gray-500 dark:text-slate-400 mt-2">You do not have permission to submit PTW permits.</p>
            </div>
        );
    }
    ...
    if (success) {
        return (
            <div className="max-w-lg mx-auto text-center py-20">
                ...
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200">Permit {success} Submitted!</h2>
                <p className="text-gray-500 dark:text-slate-400 mt-2">Redirecting to permits list...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <button
                ...
                className="flex items-center gap-2 text-sm text-gray-500 dark:text-slate-400 hover:text-indigo-600 mb-6 transition-colors"
            >
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5" encType="multipart/form-data">
                    ...
                    <div className="bg-gray-50 dark:bg-slate-950/50 border border-dashed border-gray-300 rounded-xl px-4 py-3 text-sm text-gray-500 dark:text-slate-400 italic">
                    ...
                    <div>
                        ...
                        <input
                            type="file"
                            accept="image/*"
                            className="w-full text-sm text-gray-600 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100 cursor-pointer"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <label htmlFor="contractorToggle" className="text-sm font-semibold text-gray-700 dark:text-gray-300 cursor-pointer">
                    ...
                    <div>
                        ...
                        <input
                            readOnly
                            className={`${inputClass} bg-gray-50 dark:bg-slate-950/50 text-gray-600 dark:text-gray-400 italic cursor-not-allowed`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6">
                        {safetyMeasures.filter(sm => sm.is_active === 1).map(opt => (
                            <label key={opt.id} className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <span className="text-sm text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 transition-colors" dir="rtl">
                                    {opt.measure_name}
                                </span>
                            </label>
                        ))}
