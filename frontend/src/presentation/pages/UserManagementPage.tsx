...
const roleBadge = (type: number, t: any) => {
    ...
    const s = map[type] ?? { label: t('roles.unknown', 'Unknown'), style: 'bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-slate-700' };
        ...
        <div className="max-w-full mx-auto space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm font-medium text-gray-500 dark:text-slate-400 mt-2 ml-14">{t('users.subtitle')} • {t('users.totalActive', { count: users.length })}</p>
                </div>
            </div>

            <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden relative">
                {isLoading ? (
                    <div className="p-10 space-y-4">
                        {[...Array(6)].map((_, i) => <div key={i} className="h-16 bg-gray-50 dark:bg-slate-950/50 rounded-2xl animate-pulse" />)}
                    </div>
                ) : users.length === 0 ? (
                    <div className="text-center py-24 bg-gray-50 dark:bg-slate-950/50/50">
                        <div className="w-20 h-20 bg-gray-100 dark:bg-slate-800 rounded-[2rem] flex items-center justify-center mx-auto mb-6">
                            <Search size={40} className="text-gray-300" />
                        </div>
                        <p className="text-gray-500 dark:text-slate-400 font-bold uppercase tracking-widest text-sm">{t('users.noRecords', 'No identity records found')}</p>
                    </div>
                ) : (
                                    ...
                                    <tr key={u.id} className="hover:bg-purple-50/30 transition-all duration-300 group">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div className="text-gray-900 dark:text-gray-100 font-black tracking-tight">{u.username}</div>
                                        ...
                                        <td className="px-8 py-5">
                                            <div className="text-sm font-bold text-gray-700 dark:text-gray-300">{u.department}</div>
                                        ...
                                        <td className="px-8 py-5 text-right rtl:text-left">
                                            <button 
                                                ...
                                                className="p-2.5 bg-white dark:bg-slate-900 text-gray-400 border border-gray-100 dark:border-slate-800 rounded-xl hover:bg-purple-600 hover:text-white hover:border-purple-600 hover:shadow-lg hover:shadow-purple-100 transition-all"
                                                title={t('common.edit')}
                                            >
            ...
            {editingUserId && (
                <div className="fixed inset-0 z-[100] flex justify-end">
                    ...
                    <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 h-screen shadow-2xl overflow-y-auto animate-in slide-in-from-right rtl:slide-in-from-left duration-500 ease-out">
                        <div className="sticky top-0 z-20 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 px-8 py-6 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-purple-50 text-purple-600 rounded-2xl">
                                    <User size={24} />
                                </div>
                                <div>
                                    <h2 className="text-xl font-black text-gray-900 dark:text-gray-100">{t('users.profileEngine')}</h2>
                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-0.5">{t('users.accountId')}: #{editingUserId}</p>
                                </div>
                            </div>
                            <button 
                                onClick={() => setEditingUserId(null)}
                                className="p-2 text-gray-400 hover:bg-gray-100 dark:bg-slate-800 rounded-xl transition-colors"
                            >
                                <X size={24} />
                            </button>
                        </div>
                            ...
                            <form onSubmit={handleSave} className="p-8 space-y-10">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-sm font-black text-gray-900 dark:text-gray-100 uppercase tracking-wider">{t('users.identityDetails')}</h3>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input 
                                                    ...
                                                    className="w-full pl-11 rtl:pl-4 rtl:pr-11 pr-4 py-3 bg-gray-50 dark:bg-slate-950/50 border-none rounded-2xl focus:ring-2 focus:ring-purple-600 font-bold text-gray-700 dark:text-gray-300 outline-none transition-all"
                                                    required
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select 
                                                ...
                                                className="w-full px-4 py-3 bg-gray-50 dark:bg-slate-950/50 border-none rounded-2xl focus:ring-2 focus:ring-purple-600 font-bold text-gray-700 dark:text-gray-300 outline-none transition-all cursor-pointer appearance-none"
                                            >
                                    ...
                                    <div className="flex items-center gap-4 bg-gray-50 dark:bg-slate-950/50 p-4 rounded-3xl border border-gray-100 dark:border-slate-800">
                                        <div className="flex-1">
                                            <p className="text-xs font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">{t('users.activeStatus')}</p>
                                        ...
                                        >
                                            <div className={`absolute top-1 left-1 bg-white dark:bg-slate-900 w-6 h-6 rounded-full shadow-md transition-transform duration-300 ${formData.status === 1 ? 'translate-x-6' : ''}`} />
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6 pb-24">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <h3 className="text-sm font-black text-gray-900 dark:text-gray-100 uppercase tracking-wider">{t('users.permissions')}</h3>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {Object.entries(groupedPermissions).map(([page, perms]: [string, any]) => (
                                            <div key={page} className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-5 space-y-4 hover:border-purple-200 transition-colors group">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 bg-gray-50 dark:bg-slate-950/50 text-gray-400 group-hover:bg-purple-50 group-hover:text-purple-600 rounded-xl flex items-center justify-center transition-colors">
                                                    ...
                                                    {perms.map((p: any) => (
                                                        ...
                                                        >
                                                            <div className="flex flex-col">
                                                                <span className={`text-[11px] font-bold ${selectedPermissions.includes(p.value) ? 'text-purple-700' : 'text-gray-600 dark:text-gray-400'}`}>
                                                                    {p.description}
                                                                </span>
                                ...
                                {/* Save Button */}
                                <div className="fixed bottom-0 right-0 rtl:left-0 w-full max-w-2xl bg-white dark:bg-slate-900/80 backdrop-blur-md border-t border-gray-100 dark:border-slate-800 p-8 flex gap-4 z-30">
                                    <button 
                                        type="submit"
                                    ...
                                    <button 
                                        type="button"
                                        onClick={() => setEditingUserId(null)}
                                        className="px-8 py-4 bg-gray-100 dark:bg-slate-800 text-gray-400 rounded-3xl font-black uppercase tracking-widest text-xs hover:bg-gray-200 transition-all"
                                    >
                                        {t('common.cancel')}
                                    </button>
                                </div>
